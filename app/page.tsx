      ...
      <div className="w-screen max-w-screen-md lg:max-w-screen-lg">
        <div className="flex justify-center max-w-2xl">
          <div className="p-4">
            ...
            <p className="text-lg sm:text-base text-zinc-600 mt-6 sm:mt-5">
              Hey, I&apos;m Pranav. I&apos;m a <span className="text-gray-800 font-bold">TypeScript Engineer</span> focused on efficient application development. I&apos;m passionate about coding and constantly learning to improve.
            </p>
            <p className="text-lg sm:text-base text-zinc-600 mt-5">
